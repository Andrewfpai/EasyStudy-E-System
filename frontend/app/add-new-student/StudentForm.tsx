      ...
      >
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="flex flex-col flex-1">
            ...
            <textarea ref={notesRef} placeholder="Tulis catatan disini ..." className="px-4 py-2 border border-E-gray-b rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition h-full resize-y placeholder:text-E-gray"/>
          </div>
